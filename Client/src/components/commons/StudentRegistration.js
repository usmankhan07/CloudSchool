...
class StudentRegister extends React.Component {
    ...
    this.state = { name: '', fathername: '', email: '', password: '', InstitutionName: '', classname: '',
        ...
        axios.post("http://localhost:3001/api/account/StudentRegistration",
            this.setState({
                name:this.handleStudentname(),
            ...
            <div>
                ...
                <form className={classes.form}>
                    <FormControl margin="normal" required fullWidth>
                        ...
                        <Input name="name" type="name" id="name" value = {this.name} onChange = {this.handleStudentname} autoComplete="name" />
                    </FormControl>
                    <FormControl margin="normal" required fullWidth>
...
export default withRouter(withStyles(styles)(StudentRegister));